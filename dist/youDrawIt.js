(function(f){if(typeof exports==="object"&&typeof module!=="undefined"){module.exports=f()}else if(typeof define==="function"&&define.amd){define([],f)}else{var g;if(typeof window!=="undefined"){g=window}else if(typeof global!=="undefined"){g=global}else if(typeof self!=="undefined"){g=self}else{g=this}g.youDrawIt = f()}})(function(){var define,module,exports;return (function e(t,n,r){function s(o,u){if(!n[o]){if(!t[o]){var a=typeof require=="function"&&require;if(!u&&a)return a(o,!0);if(i)return i(o,!0);var f=new Error("Cannot find module '"+o+"'");throw f.code="MODULE_NOT_FOUND",f}var l=n[o]={exports:{}};t[o][0].call(l.exports,function(e){var n=t[o][1][e];return s(n?n:e)},l,l.exports,e,t,n,r)}return n[o].exports}var i=typeof require=="function"&&require;for(var o=0;o<r.length;o++)s(r[o]);return s})({1:[function(require,module,exports){
...
var simplifyData = function simplifyData(_ref) {
  var fullData = _ref.fullData,
      x_key = _ref.x_key,
      y_key = _ref.y_key;
  return fullData.map(function (d) {
    return { x: d[x_key], y: d[y_key] };
  });
};
...
var appendSVG = function appendSVG(_ref2) {
  var sel = _ref2.sel,
      ...
      width = _ref2.width,
      margin = _ref2.margin;
  return sel.append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")");
};
...
var makeClip = function makeClip(_ref6) {
  var svg = _ref6.svg,
      scales = _ref6.scales,
      reveal_extent = _ref6.reveal_extent,
      height = _ref6.height;
  return svg.append('clipPath').attr("id", "clip").append('rect').attr("width", scales.x(reveal_extent) - 2).attr("height", height);
};
...
};var dragCanvas = function dragCanvas(_ref8) {
  var svg = _ref8.svg,
      width = _ref8.width,
      height = _ref8.height;
...
var addToClosest = function addToClosest(_ref9) {
  var usersData = _ref9.usersData,
      x_pos = _ref9.x_pos,
      y_pos = _ref9.y_pos;
  ...
  var closest_index = usersData.map(function (d) {
    return Math.abs(d.x - x_pos);
  }).reduce(function (min_index, cur_val, cur_index, arr) {
    return cur_val < arr[min_index] ? cur_index : min_index;
  }, 0);
...
var _require = require('./helpers'),
    simplifyData = _require.simplifyData,
    appendSVG = _require.appendSVG,
    makeScales = _require.makeScales,
    makeLine = _require.makeLine,
    makeClip = _require.makeClip,
    testImport = _require.testImport,
...
var drawIt = function drawIt(params) {
  _classCallCheck(this, drawIt);

  var fullData = params.data,
  ...
  //user's drawn data
  var userLine = svg.append('path').style("stroke", "steelblue").style("stroke-width", 3).style("stroke-dasharray", "5 5");

  var usersData = makeUserData({ data: data, reveal_extent: reveal_extent });
